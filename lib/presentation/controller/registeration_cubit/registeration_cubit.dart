...
import 'package:chat_app/presentation/controller/registeration_cubit/registeration_states.dart';
...
// Create SignOut Method
  ...
  void addMessageToFireStore({required message, required String email}) {
    MessageModel messageModel =
        MessageModel(message: message, email: email, dateTime: DateTime.now().toString());
